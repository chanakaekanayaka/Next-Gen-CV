  ...
  return (
    <div className='space-y-6'>
        ...
        <div>
         ...
         <button onClick={addEducation} className='flex items-center gap-2 px-3 py-1 text-sm bg-purple-300 text-purple-700
            ...
            {data.map((education, index)=>(
                <div key={index} className='p-4 border border-gray-300 rounded-lg space-y-3'>
                    ...
                    <div className='grid md:grid-cols-2 gap-3'>
                        ...
                        type='text' placeholder='Degree(e.g, Bachelors , Masters)' className='px-3 py-2 text-sm rounded-lg'/>

                         <input value={education.field || ""} 
                        onChange={(e)=>updateEducation(index , "field", e.target.value)}
                        type='text'  className='px-3 py-2 text-sm rounded-lg' placeholder='field of study'/>
                        ...
                        type='text'  className='px-3 py-2 text-sm rounded-lg' placeholder='GPA(optional)'/>
