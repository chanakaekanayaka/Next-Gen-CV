...
const Contact = () => {
  return (
        ...
        <div className="max-w-5xl w-full mx-auto p-10 text-gray-800 flex flex-col ">
            <span className="px-2 py-1 text-xs border border-gray-300 rounded-full text-center mx-auto bg-blue-500 hover:bg-white cursor-pointer ">Reach Out To Us</span>
            <h1 className="text-3xl font-semibold text-center mx-auto py-4">
                We'd love to Hear From You.
            </h1>
            <p className="text-center mt-px ">
                Or just reach out manually to 
                <a href="mailto:chanakaekanayaka15@gmail.com" className="text-indigo-600 hover:underline">chanakaekanayaka15@gmail.com</a>
            </p>
            <div className="grid md:grid-cols-3 mt-10">
                <div>
                    <svg className="text-indigo-500 transition-transform duration-700  hover:rotate-[360deg] bg-indigo-500/20  p-2.5 aspect-square rounded-full size-10" width="24"
                    ...
                    <a href="chanakaekanayaka15@.com" className="text-indigo-600 hover:scale-105  duration-300 font-semibold">
                ...
                <div>
                    ...
                    <span className="text-indigo-600 font-semibold ">
                        No 11,Kailagoda , Badulla
                    </span>
                </div>
                <div>
                    <svg className="text-indigo-500 transition-transform duration-700  hover:rotate-[360deg] bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10" width="21"
                    ...
                    <span className="text-indigo-600 font-semibold transition-transform duration-700">
                        (+94) 786365087
                    </span>
                </div>
            </div>
