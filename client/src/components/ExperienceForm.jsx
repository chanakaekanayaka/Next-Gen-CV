  ...
  return (
    <div className='space-y-6'>
        ...
        <div>
         ...
         <button onClick={addExperience} className='flex items-center gap-2 px-3 py-1 text-sm bg-purple-300 text-purple-700
            ...
            {data.map((experience, index)=>(
                <div key={index} className='p-4 border border-gray-300 rounded-lg space-y-3'>
                    ...
                    <div className='grid md:grid-cols-2 gap-3'>
                        ...
                        type='month' disabled={experience.is_current} className='px-3 py-2 text-sm rounded-lg disabled:bg-gray-200'/>
                    ...
                    <div className='space-y-2'>
                        <div className='flex items-center justify-between'>
                            ...
                            text-xs bg-purple-200 text-purple-800 rounded hover:bg-purple-200 
